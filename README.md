...
**解决方案 / Solution**：
- 确保使用最新版本的模组（v2.1.0+）/ Ensure using the latest mod version (v1.5.1+)
...
- **v2.0.0**: 完全重写架构，采用客户端渲染和事件系统技术 / Complete architecture rewrite with client-side rendering and event system
